...
INSERT INTO `rustcdc` (`varchar_l`, `varchar_s`, `text_s`, `text_m`, `text_l`, `num_float`, `num_double`, `num_decimal`) VALUES ('abc', 'abc', 'abc', 'abc', 'abc', 1.0, 2.0, 3.0);



UPDATE rustcdc set varchar_l='xd', varchar_s='xd', text_s='xd', text_m='xd', text_l='xd', num_float=4.0, num_double=4.0, num_decimal=4.0;
